    ...
    <div className='max-w-6xl mx-auto'>
      ...
      <div className='grid lg:grid-cols-2 gap-8'>
        ...
        <div className='bg-card border border-border rounded p-8 md:p-10'>
          <h3 className='font-heading text-2xl font-semibold mb-6 text-gold-gradient'>
        ...
        <div className='rounded overflow-hidden border border-border h-[400px] lg:h-auto'>
          <iframe
            src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.7220387241996!2d80.0017714!3d6.4297438!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae22f0005a50325%3A0x71fda3bd079f11af!2sNethmi%20Gem%20%26%20Juwellery!5e0!3m2!1sen!2slk!4v1772799715668!5m2!1sen!2slk'
            width='600'
            height='450'
            style={{ border: 0 }}
            allowFullScreen
